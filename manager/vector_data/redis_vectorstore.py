...
from redis.commands.search.index_definition import IndexDefinition, IndexType # 수정한 부분
...
class RedisVectorStore(VectorBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._client = Redis(
            host=host, port=int(port), username=username, password=password, **kwargs
        )
        self.top_k = top_k
